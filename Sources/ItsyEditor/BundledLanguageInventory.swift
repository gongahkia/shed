...
public enum BundledLanguageInventory {
	...
	private static let sourceKit = BundledLanguageServer(id: "sourcekit-lsp", command: "/usr/bin/xcrun", args: ["sourcekit-lsp"], rootPatterns: ["Package.swift", ".git"], executableProbe: "sourcekit-lsp", installHint: "part of Xcode, install via `xcode-select --install`")
	private static let typescript = BundledLanguageServer(id: "typescript-language-server", command: "typescript-language-server", args: ["--stdio"], rootPatterns: ["tsconfig.json", "package.json", ".git"], executableProbe: "typescript-language-server", installHint: "`npm i -g typescript typescript-language-server`")
	private static let javascript = BundledLanguageServer(id: "typescript-language-server", command: "typescript-language-server", args: ["--stdio"], rootPatterns: ["package.json", "jsconfig.json", ".git"], executableProbe: "typescript-language-server", installHint: "`npm i -g typescript typescript-language-server`")
	private static let rustAnalyzer = BundledLanguageServer(id: "rust-analyzer", command: "rust-analyzer", args: [], rootPatterns: ["Cargo.toml", ".git"], executableProbe: "rust-analyzer", installHint: "`rustup component add rust-analyzer`")
	private static let pyright = BundledLanguageServer(id: "pyright", command: "pyright-langserver", args: ["--stdio"], rootPatterns: ["pyproject.toml", "setup.py", "setup.cfg", ".git"], executableProbe: "pyright-langserver", installHint: "`npm i -g pyright`")
	private static let gopls = BundledLanguageServer(id: "gopls", command: "gopls", args: [], rootPatterns: ["go.mod", ".git"], executableProbe: "gopls", installHint: "`go install golang.org/x/tools/gopls@latest`")
	private static let clangd = BundledLanguageServer(id: "clangd", command: "clangd", args: [], rootPatterns: ["compile_commands.json", "compile_flags.txt", ".clangd", ".git"], executableProbe: "clangd", installHint: "`brew install llvm` and add LLVM's bin directory to PATH")
	private static let zls = BundledLanguageServer(id: "zls", command: "zls", args: [], rootPatterns: ["build.zig", ".git"], executableProbe: "zls", installHint: "`brew install zls`")
	private static let elixir = BundledLanguageServer(id: "elixir-ls", command: "elixir-ls", args: [], rootPatterns: ["mix.exs", ".git"], executableProbe: "elixir-ls", installHint: "`brew install elixir-ls`")
	private static let kotlin = BundledLanguageServer(id: "kotlin-language-server", command: "kotlin-language-server", args: [], rootPatterns: ["settings.gradle.kts", "settings.gradle", "build.gradle.kts", "build.gradle", ".git"], executableProbe: "kotlin-language-server", installHint: "`brew install fwcd/kotlin-language-server/kotlin-language-server`")
	private static let omnisharp = BundledLanguageServer(id: "omnisharp", command: "omnisharp", args: ["--languageserver"], rootPatterns: ["omnisharp.json", "global.json", "Directory.Build.props", ".git"], executableProbe: "omnisharp", installHint: "`brew install omnisharp`")
	private static let bashLanguageServer = BundledLanguageServer(id: "bash-language-server", command: "bash-language-server", args: ["start"], rootPatterns: [".git"], executableProbe: "bash-language-server", installHint: "`npm i -g bash-language-server`")
	private static let docker = BundledLanguageServer(id: "docker-langserver", command: "docker-langserver", args: ["--stdio"], rootPatterns: [".git"], executableProbe: "docker-langserver", installHint: "`npm i -g dockerfile-language-server-nodejs`")
	private static let sqls = BundledLanguageServer(id: "sqls", command: "sqls", args: [], rootPatterns: [".git"], executableProbe: "sqls", installHint: "`brew install sqls`")
	private static let dart = BundledLanguageServer(id: "dart", command: "dart", args: ["language-server", "--protocol=lsp"], rootPatterns: ["pubspec.yaml", ".git"], executableProbe: "dart", installHint: "`brew install dart-sdk`")
	private static let haskell = BundledLanguageServer(id: "haskell-language-server", command: "haskell-language-server-wrapper", args: ["--lsp"], rootPatterns: ["hie.yaml", "stack.yaml", "cabal.project", "package.yaml", ".git"], executableProbe: "haskell-language-server-wrapper", installHint: "`brew install haskell-language-server`")
	private static let lua = BundledLanguageServer(id: "lua-language-server", command: "lua-language-server", args: [], rootPatterns: [".luarc.json", ".luarc.jsonc", ".git"], executableProbe: "lua-language-server", installHint: "`brew install lua-language-server`")
	private static let ruby = BundledLanguageServer(id: "ruby-lsp", command: "ruby-lsp", args: [], rootPatterns: ["Gemfile", ".git"], executableProbe: "ruby-lsp", installHint: "`gem install ruby-lsp`")
	private static let terraform = BundledLanguageServer(id: "terraform-ls", command: "terraform-ls", args: ["serve"], rootPatterns: [".terraform", ".git"], executableProbe: "terraform-ls", installHint: "`brew install hashicorp/tap/terraform-ls`")
}
