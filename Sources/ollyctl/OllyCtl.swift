...
struct OllyCtl: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [
            ...
            ListWindows.self,
            ListDisplays.self,
            ListCooperativeApps.self, ExplainWindow.self, ExplainRule.self,
            Focus.self,
            MoveWindow.self,
            MoveToDisplay.self,
            Swap.self,
            ...
            ToggleSticky.self,
            TogglePinned.self,
            SnapWindow.self, DispatchGesture.self, ShowOverlay.self,
            SwitchTag.self,
            MoveToTag.self,
            ToggleTag.self,
            SetEngine.self,
            ...
            RestoreWindows.self,
            ScratchpadAdd.self,
            ScratchpadToggle.self,
            ScratchpadList.self,
            ScratchpadRemove.self,
            Macro.self,
            RunRawAction.self,
            SetSpacePolicy.self,
            SetFocusPolicy.self,
