...
@Test func settingsCatalogUpdatesValuesUsingDirectValidation() {
	...
	#expect(ItsySettingsCatalog.update(value: "false", for: "git.auto_ignore_itsy", in: &settings) == nil)
	...
	#expect(ItsySettingsCatalog.reset("git.auto_ignore_itsy", in: &settings))
