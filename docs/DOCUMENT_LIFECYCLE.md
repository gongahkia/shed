...
| Save / save-as | File path is available or supplied | Atomic write succeeds; clean; `savedContent` and timestamp advance; backup is removed | Write failure leaves the buffer dirty and its in-memory content unchanged. |
