...
`@resultBuilder enum GestureBuilder`
...
### fourFingerHorizontal(_:)

`func fourFingerHorizontal(_ action: GestureAction) -> GestureBinding`
...
### fourFingerVertical(_:)

`func fourFingerVertical(_ action: GestureAction) -> GestureBinding`
