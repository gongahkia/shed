...
final class PaletteController {
    ...
    private static final List<PaletteAction> SURFACE_ACTIONS = actions(
        ...
        action("About Shed", "about", "Show Shed version and local runtime details."),
        ...
        action("Table of Contents", "markdown toc", "Open the current Markdown document's table of contents."),
        ...
        action("Docker Containers", "docker", "Open the themed local Docker workbench."),
