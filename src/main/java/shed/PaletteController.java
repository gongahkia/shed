...
final class PaletteController {
    ...
    private static final List<PaletteAction> SURFACE_ACTIONS = actions(
        ...
        action("Zoom In", "zoom in", "Increase the interface scale by 10%, or specify a percentage after in."),
        action("Zoom Out", "zoom out", "Decrease the interface scale by 10%, or specify a percentage after out."),
